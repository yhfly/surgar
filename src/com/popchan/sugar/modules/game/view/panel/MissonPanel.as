...
package com.popchan.sugar.modules.game.view.panel
{
    ...
    public class MissonPanel extends BasePanel3D 
    {
        ...
        {
            var _local1:Image = ToolKit.createImage(this, Core.texturesManager.getTexture("missionbg"));
        ...
        override public function updateData(_arg1:*):void
        {
            super.updateData(_arg1);
        }
